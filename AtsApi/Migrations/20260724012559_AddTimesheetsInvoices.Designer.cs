...
namespace AtsApi.Migrations
{
    ...
    [Migration("20260724012559_AddTimesheetsInvoices")]
    partial class AddTimesheetsInvoices
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AtsApi.Models.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 24, 1, 25, 57, 99, DateTimeKind.Utc).AddTicks(4203),
                        ...
                        new
                        {
                            ...
                            ContactsJson = "[]",
                            CreatedAt = new DateTime(2026, 7, 24, 1, 25, 57, 99, DateTimeKind.Utc).AddTicks(6922),
            ...
            modelBuilder.Entity("AtsApi.Models.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<decimal>("BillHours")
                        .HasColumnType("TEXT");

                    b.Property<decimal>("BillRateHourly")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AtsApi.Models.Timesheet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AtsApi.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 7, 24, 1, 25, 57, 98, DateTimeKind.Utc).AddTicks(7405),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 7, 24, 1, 25, 57, 98, DateTimeKind.Utc).AddTicks(8600),
            ...
            modelBuilder.Entity("AtsApi.Models.Invoice", b =>
                {
                    ...
                    b.HasOne("AtsApi.Models.Placement", "Placement")
                        .WithMany()
